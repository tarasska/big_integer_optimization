...
TEST(correctness, div_long_signed) {
    ...
    big_integer d
        ("5843547357234957042396899999999997777777777777777777777777777777777779999999999999999999999999999999977777777777777770");
    big_integer e
        ("341345634561345613487563416598766666690000000000000000000000000000000000000001111111111111111111111111111111111111");
    if (d * e / e != d) throw std::runtime_error("aaaaaaaaaaaaaa");
